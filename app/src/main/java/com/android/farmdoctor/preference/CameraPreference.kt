...
internal class CameraPreference {
    ...
    fun setAutoDetect(context: Context) {
        preferences =
            context.getSharedPreferences(PREFS_AUTO_DETECT, Context.MODE_PRIVATE) as SharedPreferences
    ...
    fun setFlashLightMode(context: Context) {
        preferences = context.getSharedPreferences(PREFS_FLASHLIGHT_MODE,
    ...
    fun setLocation(context: Context) {
        preferences = context.getSharedPreferences(PREFS_ENABLE_LOCATION,
                Context.MODE_PRIVATE) as SharedPreferences
    ...
    fun setDetectionHistory(context: Context) {
        preferences = context.getSharedPreferences(PREFS_DETECTION_HISTORY,
                Context.MODE_PRIVATE) as SharedPreferences
